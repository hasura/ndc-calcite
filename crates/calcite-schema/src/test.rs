#[cfg(test)]
// TODO: To re-enable this test, we need to generate configuration
// values on the fly and then validate them against the schema.
pub mod common {
    // use std::fmt::Write;
    ...
    // */
    // fn get_path_from_project_root(ndc_metadata_path: impl AsRef<Path>) -> PathBuf {
    ...
    // fn check_value_conforms_to_schema<T: schemars::JsonSchema>(value: &serde_json::Value) {
