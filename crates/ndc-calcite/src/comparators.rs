...
#[tracing::instrument]
pub fn string_comparators(numeric_comparison_operators: &BTreeMap<String, ComparisonOperatorDefinition>) -> BTreeMap<String, ComparisonOperatorDefinition> {
...
#[tracing::instrument]
pub fn numeric_comparators() -> BTreeMap<String, ComparisonOperatorDefinition> {
    let numeric_comparison_operators = BTreeMap::from_iter([
        ...
        ("_gt".into(), ComparisonOperatorDefinition::Custom {
            argument_type: Type::Named {
                name: "DOUBLE".into(),
            }
        }),
        ("_lt".into(), ComparisonOperatorDefinition::Custom {
            argument_type: Type::Named {
                name: "DOUBLE".into(),
            }
        }),
        ("_gte".into(), ComparisonOperatorDefinition::Custom {
            argument_type: Type::Named {
                name: "DOUBLE".into(),
            }
        }),
        ("_lte".into(), ComparisonOperatorDefinition::Custom {
            argument_type: Type::Named {
                name: "DOUBLE".into(),
            }
        }),
