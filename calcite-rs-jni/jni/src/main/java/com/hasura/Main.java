...
//        JdbcTest.test();
        ...
        String modelPath = "/Users/kennethstott/test/calcite-connector/adapters/graphql/model.json";
...
//            System.out.println("************EXECUTE QUERY************");
            ...
            String sql = "SELECT  albumId, title, \"artist.name\" FROM Albums LIMIT 10";
