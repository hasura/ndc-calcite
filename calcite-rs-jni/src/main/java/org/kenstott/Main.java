...
public class Main {
    public static void main(String[] args) {
        String modelPath = "../ndc-calcite/adapters/jdbc/model.json";
        ...
        try {
            ...
            try (Connection calciteConnection = query.createCalciteConnection(modelPath)) {
                ...
                Map<String, String> c = query.getTableColumnInfo("DATES");
                System.out.println(c.toString());
                String x = query.getModels();
                System.out.println(x);
                String z1 = query.queryModels("SELECT * FROM \"ExchangeRates\" LIMIT 10");
                String z2 = query.queryModels("SELECT * FROM WACKY_COLUMN_NAMES LIMIT 10");
                String z3 = query.queryModels("SELECT \"g\" FROM WHERE \"g\" = '[Charlie is very surprised by Alice and Xavier\\'s surprise plan.]'  \"ARCHERS\"  LIMIT 10");
