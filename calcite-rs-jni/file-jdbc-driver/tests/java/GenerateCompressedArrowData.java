...
/**
 * Generate LZ4_FRAME compressed Arrow test data to test if newer Arrow version fixes compression.
 */
public class GenerateCompressedArrowData {
    
    public static void main(String[] args) throws IOException {
        File outputFile = new File("tests/data/arrow/sample_compressed.arrow");
        outputFile.getParentFile().mkdirs();
        
        System.out.println("Generating LZ4_FRAME compressed Arrow test data to: " + outputFile.getAbsolutePath());
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(outputFile);
            ...
            // Create writer with LZ4_FRAME compression 
            ArrowFileWriter arrowFileWriter = new ArrowFileWriter(
                vectorSchemaRoot, 
                null, 
                Channels.newChannel(fileOutputStream), 
                new HashMap<>(), 
                org.apache.arrow.vector.ipc.message.IpcOption.DEFAULT, 
        ...
        System.out.println("Successfully generated LZ4_FRAME compressed Arrow test data");
    }
