...
public class FileDriverTest {
    ...
    @Test
    @org.junit.Ignore("Directory connection needs investigation")
    ...
    @Test
    @org.junit.Ignore("Views need investigation")
    public void testViewsFromInlineJSON() throws SQLException, IOException {
        ...
        String views = "[{\"name\":\"product_totals\",\"sql\":\"SELECT \\\"product\\\", SUM(\\\"amount\\\") as total FROM \\\"SALES\\\" GROUP BY \\\"product\\\"\"}]";
    ...
    public void testViewsFromFile() throws SQLException, IOException {
        ...
        try (FileWriter writer = new FileWriter(viewsFile)) {
            ...
            writer.write("\"sql\":\"SELECT \\\"customer_id\\\", COUNT(*) as order_count, SUM(\\\"amount\\\") as total FROM \\\"ORDERS\\\" GROUP BY \\\"customer_id\\\"\"}]");
        }
